...
public class SkillBadgesModel {
    ...
    public SkillBadgesModel(String badgeName, String badgeImage, String badgeRank,int badgePercentage, int gaugeExp, int star, String skill, int status, int points) {
